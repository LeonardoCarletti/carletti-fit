...
export default function GuiaMarcasExpandidoPage() {
  return (
    <div className="bg-[#0a0a0a] text-white min-h-screen">
      ...
      <main className="pt-20 px-6 md:px-8 pb-12 max-w-4xl mx-auto">
        <ToolPlaceholder
          ...
          title="Guia de Marcas no Supermercado"
          description="Compare marcas, entenda rótulos e faça compras inteligentes sem cair em marketing enganoso."
          icon="storefront"
          sourceFile="guia-expandido-v2.jsx"
        />
      </main>
    </div>
  );
